...
exports.startRound = async (req, res) => {
  ...
  Generate **exactly 15-16 personalized interview questions** for this round, considering human psychology. Structure the questions as follows:
  ...
  16. [Question 16]
      ...
      try {
        ...
        .text()
        .split('\n')
        .filter(q => /^\d+\.\s/.test(q.trim())); // Corrected filter logic
      
        // Send questions to the view for the interview
